          ...
          <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
              <section class="album">
                ...
                <img class="img-fluid" src="images/album-covers/five-leaves-left.jpg" alt="Five Leaves Left album art" />
                <ol>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <section class="album">
                <h3>Bryter Layter</h3>
                <img class="img-fluid" src="images/album-covers/bryter-layter.png" alt="Bryter Layter album art" />
                <ol>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <section class="album">
                <h3>Pink Moon</h3>
                <img class="img-fluid" src="images/album-covers/pink-moon.jpg" alt="Pink Moon album art" />
                <ol>
            ...
            <div class="col-lg-3 col-md-5 col-sm-6 misc-collection">
              <section class="album">
                <h3>Other</h3>
                <img class="img-fluid" src="images/album-covers/family-tree.jpg" alt="Family Tree album art" />
                <ul>
